    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <input
          ...
          required
          minLength={8}
          className="w-full px-3.5 py-2.5 pr-12 border border-border rounded-lg bg-surface text-[15px] text-text-primary placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent transition-all shadow-sm"
