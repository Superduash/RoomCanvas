...
export function CaptureButton({ onClick, disabled }: CaptureButtonProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed bottom-[env(safe-area-inset-bottom,48px)] left-1/2 -translate-x-1/2 z-30 flex items-center justify-center rounded-full w-[72px] h-[72px] shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all touch-manipulation mb-8",
        disabled 
